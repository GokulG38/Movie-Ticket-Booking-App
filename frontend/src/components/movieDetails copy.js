...
//     function formatDate(isoDatesAndTimes) {
//         return isoDatesAndTimes.map(dateTimeString => {
...
//             };
//             return {
//                 date: dateTime.toLocaleString('en-US', options)
//             };
//         });
//     }
...
//         try {
//             const data = await axios.get(`http://www.localhost:5000/movies/${movieId}`)

//             const moviejson = await data.data
//             console.log("a",moviejson.movie)

//             setMovieDetails(moviejson.movie)
...
//                                 <button onClick={handleMovieDelete} className="bg-gray-100 hover:bg-gray-200 text-black font-bold py-2 px-4 rounded mt-2">Delete</button>
...
//                             {formatDate(movieDetails.showTimings).map((date, index) => (
//                                 <>
//                                     {console.log(date)}
//                                     <div key={index} className="bg-gray-300 border border-black p-2 m-3 rounded-md text-center" style={{ width: "200px", height: "200px" }}>
//                                         <p className="text-lg mb-2">{date.date.split(',')[1]}</p>
//                                         <p className="text-lg mb-2">{date.date.split(',')[0]}</p>
//                                         <p className="text-lg mb-2">{date.date.split(',')[2]}</p>
//                                         {!isAdmin && isUser && (
//                                             <Link to={`/user/${userId}/movie/${movieId}/bookTickets`} state={date}>
//                                                 <button className="bg-gray-100 hover:bg-gray-200 text-black font-bold py-2 px-4 rounded mt-2">Book Ticket</button>
//                                             </Link>)}
//                                         {!isAdmin && !isUser && (
//                                             <Link to="/login">
//                                                 <button className="bg-gray-100 hover:bg-gray-200 text-black font-bold py-2 px-4 rounded mt-2">Book Ticket</button>
