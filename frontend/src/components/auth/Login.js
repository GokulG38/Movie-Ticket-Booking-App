...
// import { sendAdminLogRequest, sendUserLogRequest } from '../../utils/Authentication';
...
//                         <h4><b>{isAdmin ? 'Admin Login' : 'User Login'}</b></h4>
//                         <p className="text-secondary">Please enter your email and password to log in</p>
...
//                             <button type="submit" className="btn btn-info col-6">Login</button>
//                         </div>
...
//                         Don't have an account? <Link to="/signup" className="text-info no-underline">Sign up here</Link>
//                     </div>
//                 )}

//                 <div className="mt-3 text-left">
//                     <Link to="/" className="text-info no-underline">{"<< Home"}</Link>
//                 </div>
